...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "frontend-lb" do |traefik|
        ...
        traefik.vm.hostname = "frontend-lb"
        traefik.vm.network :public_network, ip: PUBLIC_IP_NW + "#{FRONTEND_LB_IP_START}", bridge: [
            "eth0",
            "en0: Wi-Fi",
            "en0: Wi-Fi (AirPort)",
            "en0: Wi-Fi (Wireless)",
